...
| Endpoint              | HTTP | Params                                                           | Description                    |
| --------------------- | ---- | ---------------------------------------------------------------- | ------------------------------ |
| /avalanche/price/usdt | POST | targetTokenAddress, targetTokenSymbol, targetTokenAndUSDTPoolABI | Get token price by its address |

Exemple of formdata :
```json
{
    "targetTokenAddress": "0x9ee0a4e21bd333a6bb2ab298194320b8daa26516",
    "targetTokenSymbol": "WAVAX",
